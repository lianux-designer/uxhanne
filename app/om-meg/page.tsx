    ...
    <main className="relative min-h-screen w-full overflow-hidden font-sans">
      ...
      <div className="relative z-10 flex min-h-screen w-full flex-col items-center justify-center px-4 pt-16 text-center">
        <motion.div
          ...
          className="max-w-2xl"
        >
          <h1 className="mb-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">om meg</h1>

          <div className="mx-auto max-w-xl">
            <p className="mb-8 text-lg leading-relaxed text-gray-600">
              Her kommer det snart mer informasjon om min bakgrunn, erfaring og tilnærming til UX-design og ledelse.
            </p>
          </div>
        </motion.div>
